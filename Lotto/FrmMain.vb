...
#Region "Common Function EXCEL"
    Private Sub Load_Excel_Details()
        ...
        Try
            ...
            If flagGet = True Then
                sql = "select no as เลข,cutting as บน  from temp "
            Else
                sql = "select no as เลข,price as บน  from temp "
            End If

            dt = _BLL.ExecuteDatatable(sql)
    ...
    Private Sub Load_Excel_Details2under()
        ...
        Try
            ...
            If flagGet = True Then
                sql = "select no as เลข,cutting  as ล่าง from temp2under "
            Else
                sql = "select no as เลข,price  as ล่าง from temp2under "
            End If
            Dim _BLL As New BLL.Data()
            dt = _BLL.ExecuteDatatable(sql)
    ...
    Private Sub Load_Excel_Details3()
        ...
        Try
            ...
            sql = "select no as เลข,cutting as ราคา  from temp_x "
            Dim _BLL As New BLL.Data()
    ...
    Private Sub Load_Excel_Details3_Tod()
        ...
        Try
            Dim sql As String
            ' sql = "select no_,cutting from temp_x where cutting > 0"
            sql = "select no as เลข,cutting as ราคา  from temp_tod_120 "
            Dim _BLL As New BLL.Data()
...
#End Region
    ...
    Private Function ConvertToDataTable() As DataTable
        ...
        Dim excel As New FileInfo(Me.tbPath_asset.Text)
    ...
    Private Sub bindFilename3()
        ...
        Dim _BLL As New BLL.Data()
        dt1 = _BLL.ExecuteDatatable(sql2)
    ...
    Private Function chkFilename(ByVal file_name As String) As Boolean
        ...
        dt = _BLL.CheckFilename(file_name)
    ...
    Private Sub btPath_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btPath.Click
        ...
        OpenFileDialog1.Filter = "xls files (*.xlsx)|*.xlsx"
    ...
    Private Sub insertDB_TMP()
        ...
        Try
            ...
            For i = 0 To Dg1.RowCount - 2
                ...
                sql += " update  temp set price = price + " & price_on & " where no = '" & No_ & "';" & vbCrLf
                sql += " update  temp2under set price = price + " & price_under & " where no = '" & No_ & "';" & vbCrLf
    ...
    Private Sub insertDB_TMP2under()
        ...
        Try
            ...
            For i = 0 To DGDT2under.RowCount - 2
                ...
                Else
                    ' sql = "insert into  temp (price,no_) values(" & price & ",'" & No_ & "')"
                    sql = "update  temp2under set price=price + " & price & " where no = '" & No_ & "'"
    ...
    Private Function getMax() As String
        ...
        Dim dt1 As DataTable
        dt1 = _BLL.ExecuteDatatable(sql1)
        ...
        If dt.Rows.Count > 0 Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If tmp <= tmpRight Then
                    ...
                    sql = "select no from temp where getting = " & show


                    Dim dt2 As DataTable
                    dt2 = _BLL.ExecuteDatatable(sql)
                    Dim ddd As String
                    ddd = newTmp '+ profit_arm(dt2.Rows(0)("no").ToString())
                    '#################    CORE   ###########################
                    'Edit percenatge ##############################3
                    If ddd < 0 Then
                        MsgBox("Not get")
        ...
        If dt.Rows.Count > 0 Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If tmp <= tmpRight Then
                    ...
                    Dim no_max As String
                    sql = "select no from temp2under where getting =" & show
        ...
        If dt.Rows.Count > 0 Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If tmp <= tmpRight Then
                    ...
                    Dim no_max As String
                    sql = "select no from temp_x where getting =" & show
        ...
        If dt.Rows.Count > 0 Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If tmp <= tmpRight Then
                    ...
                    Dim no_max As String
                    sql = "select no from temp_tod_120 where getting =" & show
    ...
    Private Function core(ByVal ddd As Integer, ByVal count_ As Integer) As Boolean
        ...
        Dim dt As DataTable
        Dim sql As String
        sql = "select max(getting) as m from temp "
        Dim _BLL As New BLL.Data()
        ...
        sql = "select no from temp where getting =" & get_max
        ...
        ' Edit percentage ##################
        profit = profit_arm(dt2.Rows(0)("no").ToString())
    ...
    Private Function core2under(ByVal ddd As Integer, ByVal count_ As Integer) As Boolean
        ...
        Dim dt As DataTable
        Dim sql As String
        sql = "select max(getting) as m from temp2under "
        dt = _BLL.ExecuteDatatable(sql)
        get_max = dt.Rows(0)("m").ToString()


        Dim profit As String
        sql = "select no from temp2under where getting = " & get_max
        ...
        ' Edit percentage ##################
        profit = profit_arm2under(dt2.Rows(0)("no").ToString())
    ...
    Private Function core3(ByVal ddd As Integer, ByVal count_ As Integer) As Boolean
        ...
        Dim dt As DataTable
        Dim sql As String
        sql = "select max(getting) as m from temp_x "
        dt = _BLL.ExecuteDatatable(sql)
        get_max = dt.Rows(0)("m").ToString()


        Dim profit As String
        sql = "select no_ from temp_x where getting =" & get_max
    ...
    Private Function core3_tod(ByVal ddd As Integer, ByVal count_ As Integer) As Boolean
        ...
        Dim dt As DataTable
        Dim sql As String
        sql = "select max(getting) as m from temp_tod_120 "
        dt = _BLL.ExecuteDatatable(sql)
        get_max = dt.Rows(0)("m").ToString()


        Dim profit As String
        sql = "select no from temp_tod_120 where getting =" & get_max

        Dim dt2 As DataTable
        dt2 = _BLL.ExecuteDatatable(sql)
        profit = profit_arm3(dt2.Rows(0)("no").ToString())
    ...
    Private Sub selectAll(ByVal max_arm As Integer)
        ...
        sql += " SET cutting = IF(price>" & max_arm & ",price - " & max_arm & ",0)," & vbCrLf
        sql += " getting = IF(price < " & max_arm & ",price," & max_arm & ")"
    ...
    Private Sub selectAll2(ByVal max_teng_ As Integer)
        ...
        sql += " SET cutting_teng = IF(price_teng>" & max_teng_ & ",price_teng - " & max_teng_ & ",0)," & vbCrLf
        sql += " get_teng = IF(price_teng < " & max_teng_ & ",price_teng," & max_teng_ & ")"
    ...
    Private Sub selectAllTeng(ByVal max_teng_ As Integer)
        ...
        sql += " SET cutting_teng = IF([price_teng]>= " & max_teng_ & ",[price_teng] - " & max_teng_ & ",[price_teng])," & vbCrLf
        sql += " get_teng = IF(price_teng <= " & max_teng_ & ",[price_teng]," & max_teng_ & ")"
        _BLL.ExecuteNonQuery(sql)
        ...
        sql = "select no,price_teng,get_teng,cutting_teng from temp_x"
        dt = _BLL.ExecuteDatatable(sql)
        dgMain3.DataSource = dt
    ...
    Private Sub takeLotto()
        ...
        Dim sql As String
        Dim dt As DataTable
        sql = "select sum(getting) from temp"
        Dim _BLL As New BLL.Data()
    ...
    Private Sub takeLotto2under()
        ...
        Dim sql As String
        Dim dt As DataTable
        sql = "select sum(getting) from temp2under"
        Dim _BLL As New BLL.Data()
    ...
    Private Sub takeLotto3()
        ...
        Dim sql As String
        Dim dt As DataTable
        sql = "select sum(getting) from temp_x"
    ...
    Private Sub takeLotto3_tod()
        ...
        Dim sql As String
        Dim dt As DataTable
        sql = "select sum(getting) from temp_tod_120"
    ...
    Private Function profit_arm(ByVal no_ As String)
        ...
        sql += " getting * " & Int(My.Settings.two) & " as we, "
        sql += " cutting * " & Int(My.Settings.two) & " as cutting "
        sql += " from temp where no = '" & no_ & "'"
    ...
    Private Function profit_arm2under(ByVal no_ As String)
        ...
        sql += " getting * " & Int(My.Settings.twoUnder) & " as we, "
        sql += " cutting * " & Int(My.Settings.twoUnder) & " as cutting "
        sql += " from temp2under where no = '" & no_ & "'"
        Dim _BLL As New BLL.Data()
    ...
    Private Function profit_arm3(ByVal no_ As String)
        ...
        sql += " getting * " & Int(My.Settings.tree500) & " as we, "
        sql += " cutting * " & Int(My.Settings.tree500) & " as cutting "
        sql += " from temp_x where no = '" & no_ & "'"
        Dim _BLL As New BLL.Data()
    ...
    Private Function profit_arm3_tod(ByVal no_ As String)
        ...
        sql += " getting * " & Int(My.Settings.tree100) & " as we, "
        sql += " cutting * " & Int(My.Settings.tree100) & " as cutting "
        sql += " from temp_tod_120 where no = '" & no_ & "'"
    ...
    Private Sub two_()
        ...
        sql += " getting * " & Int(My.Settings.two) & " as we, "
        sql += " cutting * " & Int(My.Settings.two) & " as cutting "
        sql += " from temp where no = '" & two.Text & "'"
    ...
    Private Sub two_under()
        ...
        sql += " getting * " & Int(My.Settings.two) & " as we, "
        sql += " cutting * " & Int(My.Settings.two) & " as cutting "
        sql += " from temp2under where no = '" & twoUnder.Text & "'"
        Dim _BLL As New BLL.Data()
    ...
    Private Sub Pay_Three()
        ...
        sql += " getting * " & Int(My.Settings.tree500) & " as we, "
        sql += " cutting * " & Int(My.Settings.tree500) & " as cutting "
        sql += " from temp_x where no = '" & three.Text & "'"
        Dim _BLL As New BLL.Data()
    ...
    Private Sub Pay_Tod(ByVal strWhere As String)
        ...
        sql += " getting * " & (Int(My.Settings.tree100) / 6) & " as we, "
        sql += " cutting * " & (Int(My.Settings.tree100) / 6) & " as cutting "
        sql += " from temp_tod_120 where no in " & strWhere
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        If MessageBox.Show("ต้องการล้างข้อมูล 2 ตัวบนและล่าง เพื่อคำนวณใหม่ทั้งหมด", "คำเตือน", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
            ...
            Dim sql, sql2 As String
            sql = "update temp set price = 0,cutting=0,getting = 0"
            sql2 = "update temp2under set price = 0,cutting=0,getting = 0"


            _BLL.ExecuteNonQuery(sql)
            _BLL.ExecuteNonQuery(sql2)
    ...
    Private Sub bindDGMain()
        ...
        Dim dt As DataTable
        Dim _BLL As New BLL.Data
        Me.dgTest.DataSource = _BLL.getDataTemp()
    ...
    Private Sub bindDGMain2under()
        ...
        Dim dt As DataTable
        Dim _BLL As New BLL.Data()
        Me.DGMain_2under.DataSource = _BLL.getDataTemp2under
    ...
    Private Sub Button5_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnResetForm3.Click
        ...
        If MessageBox.Show("ต้องการล้างข้อมูล 3 ตัวเต็ง เพื่อคำนวณใหม่ทั้งหมด", "คำเตือน", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
            ...
            Dim _BLL As New BLL.Data()
            Dim sql As String
            sql = "update temp_x set price = 0,cutting=0,getting = 0" & vbCrLf
    ...
    Private Sub txtReset2under_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtReset2under.Click
        ...
        If MessageBox.Show("ต้องการล้างข้อมูล 2 ตัวล่างเพื่อคำนวณใหม่ทั้งหมด", "คำเตือน", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
            ...
            sql = "update temp2under set price = 0,cutting=0,getting = 0"
            sql2 = "update temp set price = 0,cutting=0,getting = 0"
    ...
    Private Sub btnResetForm3_tod_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnResetForm3_tod.Click
        ...
        If MessageBox.Show("ต้องการล้างข้อมูล 3 ตัวโต๊ด เพื่อคำนวณใหม่ทั้งหมด", "คำเตือน", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
            ...
            Dim sql As String
            sql = "update temp_tod_120 set price = 0,cutting=0,getting = 0" & vbCrLf
            _BLL.ExecuteNonQuery(sql)
